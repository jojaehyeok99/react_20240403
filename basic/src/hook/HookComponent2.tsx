...
export default function HookComponent2() {
  ...
  // useRef :
  // - DOM 객체를 직접 다루고자 할 때 혹은 렌더링 없이 변경 저장하고자 할 때 사용
  // const DOM객체참조변수 = useRef<DOM요소타입>(초기값);
  // DOM 객체를 참조하기 위해서 useRef를 사용하면 참조할 요소에 ref={} 속성에 해당 참조변수를 지정해야함
  ...
  const onButtonClickHandler = () => {
    ...
    // 특정 속성 및 메서드를 호출하려 할 때 null 혹은 undefined가 아닌 상태에서만
