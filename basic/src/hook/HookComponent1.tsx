...
// - 만약 컴포넌트의 코드 블럭 외에 존재하고 싶다면 그 코드블럭은 반드시 훅 함수이어야 함
...
export default function HookComponent1() {
  ...
  // useEffect : 
  // - 컴포넌트의 생명주기에 따라 특정 함수를 수행하도록 하는 함수
  // - 사용방법 : useEffect(실행할 함수, 스코프할 상태 배열);
  ...
  const SubComponent = () => {
    ...
    // 전달한 콜백 함수의 return으로 컴포넌트가 unmount 시 실행할 함수를 반환 할 수 있음
